  ...
  return (
    <section className='bg-hero bg-no-repeat bg-left-top min-h-[800px] lg:min-h-[950px] lg:mb-80'>
      ...
      >
        ...
        >
          <Image src={girlImg} width={206} height={495} alt="Hero Image" />
        </motion.div>
        ...
        >
          <Image src={truckImg} width={811} height={395} alt="Hero Image" />
        </motion.div>
        ...
        >
          <Image src={boyImg} width={206} height={495} alt="Hero Image" />
        </motion.div>
      </motion.div>
    </section>
  );
